...
public class ApiUserController {
    ...
    public GenericResponse<User> findByBatchId(@PathVariable("id") String id) {
    ...
    public GenericResponse<User> updateByBatchId(@PathVariable("id") String id, @RequestBody UserUpdateRequest request) {
        if (StringUtils.isEmpty(id)) {
            throw new BizException(BizErrorCodeEnum.ID_IS_NULL);
        }
        User user = new User();
